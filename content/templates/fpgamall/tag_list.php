...
<div class="brand">
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $tag ?? ''; ?></li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="container">
        ...
        <div class="pager">
            <div class="row mb-4">
                <div class="col-md-4">
                    <p class="total">Total: <span class="num"><span class="num"><?php echo $lognum ?? ''; ?></span></p>
                </div>
