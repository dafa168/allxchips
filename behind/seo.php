...
if ($action === 'update') {
    ...
    $getData = array(
        ...
        'show_title' => isset($_POST['show_title']) ? addslashes($_POST['show_title']) : '',
        'show_key' => isset($_POST['show_key']) ? addslashes($_POST['show_key']) : '',
        'show_desc' => isset($_POST['show_desc']) ? addslashes($_POST['show_desc']) : '',
