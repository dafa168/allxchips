...
if ($action == 'add') {
    ...
    $detail = isset($_POST['detail']) && $_POST['detail'] != 'echo_log' ? addslashes(trim($_POST['detail'])) : '';
    $description = isset($_POST['description']) ? addslashes(trim($_POST['description'])) : '';
    $seoinfo = isset($_POST['seoinfo']) ? addslashes(trim($_POST['seoinfo'])) : '';
    ...
    $Sort_Model->addSort($sortname, $alias, $pid, $description, $seoinfo, $template, $detail);
...
if ($action == 'mod_sort') {
    ...
    extract($sortData, EXTR_OVERWRITE);
...
if ($action == 'update') {
    ...
    $sort_data['detail'] = $detail;
    $sort_data['seoinfo'] = $seoinfo;
