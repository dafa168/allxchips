...
<div class="panel-heading">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link" href="./smtp.php">邮件设置</a></li>
...
<div class="card shadow mb-4 mt-2">
    <div class="card-body">
        <form action="seo.php?action=update" method="post">
            ...
            <h4 class="mt-4">产品内容页SEO信息</h4>
            <div class="form-group">
                <label>标题(title)</label>
                <input class="form-control" value="<?php echo $show_title ?? ''; ?>" name="show_title">
            </div>
            <div class="form-group">
                <label><label>关键字(keywords)</label></label>
                <input class="form-control" value="<?php echo $show_key ?? ''; ?>" name="show_key">
            </div>
            <div class="form-group">
                <label><label>描述(desc)</label></label>
                <textarea name="show_desc" class="form-control"><?php echo $show_desc ?? ''; ?></textarea>
            </div>
