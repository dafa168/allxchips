                ...
                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
					...
					foreach ($sorts as $key => $value):
                        ...
                        <tr>
                            ...
                            <td class="alias"><?php echo $value['detail']; ?></td>
                            <td>
            ...
            <form action="sort.php?action=add" method="post" id="sort_new">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="template" name="template" value="sort_list">
                        <small class="form-text text-muted">(用于自定义分类页面模板，对应模板目录下.php文件，默认：log_list.php，可不填)</small>
                    </div>
                    <div class="form-group">
                        <label for="template">内容模板</label>
                        <input class="form-control" id="detail" name="detail" value="echo_goods">
                        <small class="form-text text-muted">(用于自定义分类页面模板，对应模板目录下.php文件，默认：log_list.php，可不填)</small>
                    </div>

                    <div class="form-group">
                        <label for="alias">SEO描述</label>
                        <textarea name="seoinfo" type="text" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
