...
<div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion sd-hidden" id="accordionSidebar">
        <li class="nav-item active emlog_title" id="menu_home">
            <a class="nav-link" href="./">HTT PRO </a>
        </li>
        ...
        <li class="nav-item" id="menu_inquiry">
            <a class="nav-link" href="inquiry.php"><i class="icofont-comment"></i><span>询价</span></a>
        </li>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form action="article.php" method="get" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <input type="text" name="keyword" class="form-control bg-light border-0 small" placeholder="查找内容..." aria-label="Search" aria-describedby="basic-addon2">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link" id="UpdateCache" target="_blank" role="button">更新缓存 </a>
                    </li>
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link" href="<?php echo BLOG_URL ; ?>" target="_blank" role="button">
                            查看我的站点
                        </a>
                    </li>
